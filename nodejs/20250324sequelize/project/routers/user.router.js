...
// 조회를 하는데 자유게시판, 후기 게시판, 게시판
// userinfo/:params   원하는 이름의 파라미터
// 쿼리 스트링은 값이 없어도 요청 url의 처리가 가능 요청을 받을수있는데
// 파라미터 params 값은 요청 경로에 추가해두면 무조건 들어가야 요청을 받을수 있다
// userinfo/3 요청을 받을수 없다 
// router.get('/usersinfo/:category', (req, res) => {
...
// 로그인 페이지에서 본인인증하고 지금은 우리가 본인 pass 앱을 바로 사용할수 없으니
// 본인 인증이 있다고 가정하고
// 쿠키에 값 추가
